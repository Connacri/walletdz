...
*/
  ...
  void _textm3u(String inputText) {
    ...
    final filteredLines =
        lines.where((line) => line.startsWith('#EXTINF:')).toList();
  ...
  Future<void> fetchChannels(String mUrl) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final lines =
            LineSplitter.split(decodedResponse).toList(); // Convert to a List
        ...
        EasyLoading.showSuccess(
            Localization.get("Channels_saved_successfully"));
      ...
      child: ListView(
        children: [
          GridView.count(
            ...
            children: [
              _buildMenuItemCard(
                  Localization.get("Add_New_IPTV_from_URL"), Icons.link, () {
                _showIptvFromURLDialog(context);
              }),
              _buildMenuItemCard(
                  Localization.get("IPTV_from_TEXT"), Icons.text_fields, () {
                _showIptvFromTEXTDialog(context);
              }),
              _buildMenuItemCard(
                  Localization.get("Import_m3u_with_username_and_password"),
                  Icons.storage, () {
            ...
            child: Column(
              ...
              children: [
                TextFormField(
                  ...
                  decoration:
                      InputDecoration(labelText: Localization.get("Name")),
                ),
                ...
                children: [
                  TextField(
                    ...
                    decoration: InputDecoration(
                        labelText: Localization.get("IPTV_Text")),
                  ),
                ],
              ),
            ),
            ...
            child: Column(
              ...
              children: [
                ...
                TextFormField(
                  ...
                  decoration:
                      InputDecoration(labelText: Localization.get("Username")),
                ),
                SizedBox(height: 16.0),
                TextFormField(
