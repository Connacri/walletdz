...
import 'package:walletdz/iptv/utils/ads.dart';
import 'dart:convert';
...
/*
  ...
  void saveChannels(
      String url, String title, String category, String image) async {
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            onPressed: () {
              saveChannels(
                  widget.title, widget.title, widget.category, widget.image);
            },
            icon: Icon(
              Icons.bookmark_add,
          ...
          children: [
            ...
            Container(
              ...
              child: GridView.builder(
                ...
                itemCount: favoriteChannels.length >= 100
                    ? 100
                    : favoriteChannels.length, // Show up to 10 items
                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            ...
                            child: favoriteChannels[index].image?.isNotEmpty ??
                                    false
                                ? Image.network(
